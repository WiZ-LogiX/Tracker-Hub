...
function OrderDetail({ o, logs, photos, assignments, inspections, workers, note, setNote, onAdvance, onUpload, onDeletePhoto, onAssign, onUpdateAssignment, onDeleteAssignment, onRecordQC }: any) {
